...
\begin{table}[h!]
	...
	\begin{tblr}{
		...
		Grupa:     & IS-2(s)P1                                                            & Nr raportu: & 4 & Data: & 05.11.2024 \\
...
\begin{itemize}
	\item Porzucenie modułów Firebase Auth oraz Firestore platformy Firebase i przejście na własny backend (Payload CMS).
	\item Rozpoczęcie tworzenia panelu administratora dla pracowników uczelni.
\end{itemize}
...
\begin{itemize}
	\item Ograniczenia związane z platformą Firebase (brak dostępu do Cloud Functions).
\end{itemize}

\section{Zadania na kolejny tydzień}
\begin{itemize}
	\item Finalizacja procesu porzucenia modułów Firebase Auth oraz Firestore platformy Firebase
